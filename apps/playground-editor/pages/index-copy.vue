  ...
  <div class="relative p-10 n-bg-base">
    <div class="w-full flex gap-4 mx-auto flex-col container">
      ...
      <div class="flex gap-1 mb-5">
        <NButton n="sm" to="https://github.com/nuxt/devtools/tree/main/packages/devtools-ui-kit" target="_blank"
      ...
      <NCard class="p4">
        ...
        <div class="flex flex-col gap-2">
          <NTextInput n="lime6 dark:lime5" icon="carbon:checkmark-outline" placeholder="Hi!" />
          <NTextInput n="pink6 dark:pink5" icon="carbon:user" placeholder="Your name..." />
          <NTextInput n="lime6 dark:lime5" icon="carbon:password" type="password" placeholder="Your password..." />
        </div>
